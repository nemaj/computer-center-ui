...
export default function CustomerPage() {
  ...
  const getList = async () => {
    ...
    console.log(list.data, "<=== customer list")
...
const openCustomer = (customerId: string) => {
  ...
  return (
    <>
      <Head>
        <title>Customers Page | New World Computer Center</title>
        <meta
          name="description"
          content="This is Customer List Page of New World Computer Center."
        ></meta>
      </Head>
      <div>
        ...
        <div className="flex justify-between mb-4">
          ...
          <Button size="sm" variant="primary" startIcon={<HiOutlinePlus color="#ffffff" />}>
            Add Customer
          </Button>
        </div>
            ...
            <div className="min-w-[1102px]">
              <Table>
                ...
                <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                  {data?.map((customer) => (
                    <TableRow key={customer._id} className="cursor-pointer" onClick={() => {openCustomer(customer._id)}}>
